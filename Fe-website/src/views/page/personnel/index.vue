<template>
  <a-form class="tw-flex tw-rounded-lg tw-bg-white tw-px-6 tw-py-5 tw-mb-6">
    ...
    <a-form-item class="tw-w-[200px] !tw-mr-3">
      ...
      <a-select
        :placeholder="translate('WarehouseLocation')"
        v-model:value="filterSearching.locationSlected"
        :options="option2Fake"
        class="tw-mt-2"
      />
    </a-form-item>
...
const disabledDeleteFilter = computed(
  () => filterSearching?.keyword?.length === 0 && filterSearching?.locationSlected === null
)
