    ...
    <a-form @submit.prevent="handleSubmit" class="tw-mb-6">
      <div class="tw-w-full tw-flex tw-items-start tw-mb-6">
        <div class="tw-basis-1/2 tw-flex tw-flex-col tw-items-start tw-justify-start tw-mr-4">
          ...
          <div class="tw-mt-2 tw-w-full">
            <a-input :placeholder="translate('EmployeeCode')" v-model:value="v$.code.$model" :status="v$.code.$error ? 'error' : ''"/>
          </div>
      ...
      <div class="tw-w-full tw-flex tw-items-start tw-mb-6">
        <div class="tw-basis-1/2 tw-flex tw-flex-col tw-items-start tw-justify-start tw-mr-4">
          ...
          <div class="tw-mt-2 tw-w-full">
            <a-select class="tw-w-full" :placeholder="translate('SelectArea')" v-model:value="v$.workplace.$model"/>
          </div>
        </div>
        <div class="tw-basis-1/2 tw-flex tw-flex-col tw-items-start tw-justify-start tw-mr-4">
          <span>{{ translate("Warehouse") }}</span>
          <div class="tw-mt-2 tw-w-full">
            <a-select class="tw-w-full" :placeholder="translate('SelectWarehouse')" v-model:value="v$.warehoueName.$model"/>
          </div>
        </div>
      </div>
    </a-form>
