<template>
  ...
  <div class="tw-w-full tw-h-[510px] tw-flex tw-gap-6 tw-justify-between">
    <div class="tw-bg-white tw-rounded-xl tw-p-6">
      ...
      <a-date-picker class="tw-mb-6" :placeholder="translate('SelectDay')" v-model:value="searchingDay" />
      <div class="tw-opacity-70 tw-mb-2">{{ translate("SelectMonth") }}</div>
      <a-date-picker class="tw-mb-6" picker="month" :placeholder="translate('SelectMonth')" v-model:value="searchingMonth" />
      <div class="tw-opacity-70 tw-mb-2">{{ translate("Selectquarter") }}</div>
      <a-date-picker class="tw-mb-6" picker="quarter" :placeholder="translate('Selectquarter')" v-model:value="searchingQuarter" />
      <div class="tw-opacity-70 tw-mb-2">{{ translate("SelectYear") }}</div>
      <a-date-picker class="tw-mb-6" picker="year" :placeholder="translate('SelectYear')" v-model:value="searchingYear" />
    ...
    <div class="tw-grow tw-h-full tw-w-full">
