<template>
  ...
  <Section
    :title="translate('ListVendors')"
    :subTitle="translate('TotalSuppliers')"
...
const columns = ref<Array<any>>([
  ...
  {
    title: translate('SupplierOrigin'),
    dataIndex: 'origin',
    key: 'origin',
    align: 'left'
  },
...
const handelCreate = () => {
  ...
  titleModal.value = translate('AddSuppliers')
  isEdit.value = false
}
...
const handleUpdate = (item: FormState) => {
  ...
  isVisibleModalCreate.value = true
  isEdit.value = true
  titleModal.value = translate('UpdateSupplierInfo')
}
...
const handleDeleteMany = () => {
  ...
  titleModal.value = 'Bạn chắc chắn muốn xóa những nhà cung cấp này?'
}
