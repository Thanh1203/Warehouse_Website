<template>
  <div class="tw-w-full tw-mb-6 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 lg:tw-grid-cols-4 tw-bg-[#37404a] tw-rounded-lg tw-overflow-hidden tw-border tw-border-[#464f5b]">
    <div class="tw-h-[140px] tw-p-4 tw-flex tw-flex-col tw-items-center tw-justify-between tw-border-x-0 tw-border-y tw-border-[#464f5b] md:tw-border-x md:tw-border-y-0">
    ...
    <div class="tw-h-[140px] tw-p-4 tw-flex tw-flex-col tw-items-center tw-justify-between tw-border-x-0 tw-border-y tw-border-[#464f5b] md:tw-border-x md:tw-border-y-0">
      ...
      <div class="tw-text-[#8391a2] tw-text-base tw-truncate">{{ translate("Producer") }}</div>
    </div>
  </div>
</template>
