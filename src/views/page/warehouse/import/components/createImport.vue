...
const SectionSupplier = defineAsyncComponent(() => import('./sectionSupplier.vue'));
const SectionWarehouse = defineAsyncComponent(() => import('./secionWarehouse.vue'));
const SectionCategory = defineAsyncComponent(() => import('./sectionCategory.vue'));
