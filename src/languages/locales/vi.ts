export const vi = {
  ...
  noti: {
    ...
    deleteSupplierFail: "Không thể xóa nhà sản xuất còn sản phẩm! Vui lòng kiểm tra lại",
  ...
  TotalRecordSupplier: "Tổng số nhà cung cấp: ",
  SupplierName: "Tên nhà cung cấp",
  Origin: "Xuất xứ",
  UpdateManufacturerInfo: "Cập nhật thông tin nhà cung cấp",
  AddManufacturer: "Thêm mới nhà cung cấp",
  confirm: {
  ...
  Year: "Năm",
  Revenue: "Doanh thu",
  productCategoryRatio: "Tỷ lệ chủng loại sản phẩm",
  NumberOfWarehouses2: "Số lượng kho hàng",
  CurrentTotalRevenue: "Tổng doanh thu hiện tại",
  ...
  NumberManufacturers: "Số lượng nhà cung cấp",
  ...
  ManufacturerStatistics: "Thống kê nhà cung cấp",
