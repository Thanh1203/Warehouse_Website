export const vi = {
  ...
  warehouse: {
    ...
    soldOut: "Hết hàng",
    transfer: "Chuyển kho",
    listImport: "Danh sách đơn nhập hàng",
    numberImport: "Số lượng đơn nhập hàng",
    createImport: "Tạo đơn nhập hàng",
  ...
  inventory: {
    ...
    canSold: "Có thể bán",
    importDate: "Ngày nhập dự kiến",
    purchaseCode: "Mã đơn nhập",
  ...
  staff: {
    select: "Chọn nhân viên phụ trách",
  },
  Profile: "Hồ sơ",
