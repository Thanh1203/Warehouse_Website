export const en = {
    ...
    noti: {
        ...
        deleteSupplierFail: "Cannot delete producer that still have products! Please check again",
    ...
    SupplierList: 'Manufacturer list',
    SupplierCode: "Manufacturer code",
    TotalRecordSupplier: "Total number of manufacturers: ",
    SupplierName: "Manufacturer's name",
    Origin: "Origin",
    ...
    EnterSupplierName: "Enter the producer name",
